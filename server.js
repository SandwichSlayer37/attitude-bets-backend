...
async function getAllDailyPredictions() {
    ...
    for (const sport of SPORTS_DB) {
        ...
        for (const game of games) {
            const espnEvent = espnDataResponse?.events?.find(e => e.name.includes(espnTeamAbbreviations[game.home_team]) && e.name.includes(espnTeamAbbreviations[game.away_team]));
